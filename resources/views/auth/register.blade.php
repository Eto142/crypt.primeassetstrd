...
<head>
    <meta charset="utf-8" />
    <title>Crypto Prime Assets Trade | Register</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Register with Crypto Prime Assets Trade" name="description" />
...
<body>
    ...
    <a href="/" style="display: inline-block;">
        <img src="logo.png" alt="Logo" style="height: 50px;">
            ...
            <p class="text-center mb-4" style="color: rgba(255,255,255,0.7);">Join Crypto Prime Assets Trade today</p>
