        ...
        <div class="row">
            <div class="col-md-5 col-sm-12">
                <h1 class="slide-h1">Premium Trading. Minimal Costs <br/>
                    <span style="font-weight: 600">trading with Crypto Prime Assets Trade  </span>
                </h1>
                <p class="display-none-mobile">
    ...
    <div class="row">
        <div class="col-md-6 col-sm-12">
            <p class="lite-ash">
                ...
                Crypto Prime Assets Trade customer service is available 24/7. We are continuously adding new financial
                instruments.
            </p>
        </div>
        <!-- end column here  -->
            ...
            <div class="col-md-4 col-sm-12">
                <div class="">
                    <p class="white p-text">
                        Crypto Prime Assets Trade allows you to actively trade most popular cryptocurrencies such as
        ...
        <div class="col-test-card">
            ...
            <div class="col-test-bg">
                <img src="admin/testimony-images/8671597592136.png" class="rounded-circle img-thumbnail float-left mum"
                     width="100px">
                <p class="text-left"> I got my first investment profit of $15k. Big thanks to you guys at Crypto Prime Assets Trade??</p>
            ...
            <div class="col-test-bg">
                <img src="admin/testimony-images/8211597591949.png" class="rounded-circle img-thumbnail float-left mum"
                     width="100px">
                <p class="text-left"> Big shout out to you guys at  Crypto Prime Assets Trade. I just got my Bitcoin back. I love you guyz Crypto Prime Assets Trade??</p>
            ...
            <div class="col-test-bg">
                <img src="admin/testimony-images/6981597591504.png" class="rounded-circle img-thumbnail float-left mum"
                     width="100px">
                <p class="text-left"> Thank you Crypto Prime Assets Trade. I&#39;m debt free. I have been able to repay my loan of $64,000????</p>
            ...
            <div class="col-test-bg">
                <img src="admin/testimony-images/4941597591323.png" class="rounded-circle img-thumbnail float-left mum"
                     width="100px">
                <p class="text-left">Thank you Crypto Prime Assets Trade. You guys are amazing. I just recovered my lost bitcoin of 2.6BTC. ????</p>
            ...
            <div class="col-test-bg">
                <img src="admin/testimony-images/4111597591055.png" class="rounded-circle img-thumbnail float-left mum"
                     width="100px">
                <p class="text-left">Thank you Crypto Prime Assets Trade for keeping to your words. I invested with $2k and i just received an investment profit of $26k within a week. ???</p>
            ...
            <div class="col-test-bg">
                <img src="admin/testimony-images/5761597590797.png" class="rounded-circle img-thumbnail float-left mum"
                     width="100px">
                <p class="text-left">I want to thank Crypto Prime Assets Trade, i just received the sum of $17k from my investment. My whole family is indeed happy. I&#39;m hoping to invest big by next week.</p>
            ...
            <div class="col-test-bg">
                <img src="admin/testimony-images/5511597007223.png" class="rounded-circle img-thumbnail float-left mum"
                     width="100px">
                <p class="text-left">I want to thank Crypto Prime Assets Trade, Thank you so much, I just made my first $20k. Thank you Crypto Prime Assets Trade.</p>
            ...
            <div class="col-test-bg">
                <img src="admin/testimony-images/5321597006964.png" class="rounded-circle img-thumbnail float-left mum"
                     width="100px">
                <p class="text-left">I&#39;m now a super woman because of you guys. Thank you Crypto Prime Assets Trade.</p>
            ...
            <div class="col-test-bg">
                <img src="admin/testimony-images/5221597006888.png" class="rounded-circle img-thumbnail float-left mum"
                     width="100px">
                <p class="text-left">Thank you Crypto Prime Assets Trade.</p>
            ...
            <div class="col-test-bg">
                <img src="admin/testimony-images/6961597006775.png" class="rounded-circle img-thumbnail float-left mum"
                     width="100px">
                <p class="text-left">You guys are amazing. Thank you now I&#39;m financially stable.Crypto Prime Assets Trade is the best.</p>
            ...
            <div class="col-test-bg">
                <img src="admin/testimony-images/6391597006127.png" class="rounded-circle img-thumbnail float-left mum"
                     width="100px">
                <p class="text-left">You guys are indeed amazing Crypto Prime Assets Trade is the best.</p>
            ...
            <div class="col-test-bg">
                <img src="admin/testimony-images/3806.png" class="rounded-circle img-thumbnail float-left mum"
                     width="100px">
                <p class="text-left"> Wow! I got real profits from Crypto Prime Assets Trade. Keep up the good work.</p>
            ...
            <div class="col-test-bg">
                <img src="admin/testimony-images/723.png" class="rounded-circle img-thumbnail float-left mum"
                     width="100px">
                <p class="text-left"> Estoy muy feliz de haber cambiado pips iniciales, y Crypto Prime Assets Trade es lo
                    mejor.</p>
...
<section class=" col-testimony-bg">
    ...
    <div class="col-md-7 trade-option-1 table-responsive-sm">
        <h4><img src="images/withdrawals.png"> LATEST WITHDRAWALS<!-- Crypto Prime Assets Trade  --> </h4>
        ...
        <footer>
            <div class="container">
                ...
                <div class ="footer-logo float-left"> 
                    <img src ="images/logo.png" alt = "Crypto Prime Assets Trade.  ">
                </div>
                <!-- this image is for the secuse ssl  -->
                <div class ="footer-logo float-right"> 
                    <img src ="images/ssl.png" alt = "Crypto Prime Assets Trade.  ">
                </div>
                <div class = "clear-fix"> </div>
                <hr>
                        ...
                        <div class = "col-md-3 footer-link">
                            ...
                            reliable, guaranteed weekly income? Crypto Prime Assets Trade. offers a range of options 
                        ...
                        <div class = "col-md-3 footer-link">
                            <span> About Crypto Prime Assets Trade.     <br />
                            Crypto Prime Assets Trade.   is totally different from its competitors trying to achieve something special starting with the 
                ...
                <div class="row">
                    <div class="text-center">
                        ...
                        / &nbsp
                        <span style = "font-size: 1em">
                        <a href ="mailto:info@Crypto Prime Assets Trade..com">
                        <i class="fas fa-envelope"></i>support@Crypto Prime Assets Trade.com                    </a>
                        </span>
                    </div>
                </div>
                <!-- end container row -->
